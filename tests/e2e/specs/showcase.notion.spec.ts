...
test.describe('media', () => {
  test('inserts an image', async ({ page }) => {
    ...
    await page.locator('.re-dialog .re-image-tab', { hasText: 'Link' }).click()
    await page.locator('.re-dialog input[type="url"]').fill('https://placehold.co/200x100.png')
    await page.locator('.re-dialog button:has-text("Insert")').click()
