...
<p>Welcome to the <mark>Simple Editor</mark> template! This template integrates <strong>open source</strong> UI components and Rich Editor extensions licensed under <strong>MIT</strong>.</p>
<p>Integrate it by following the <a href="#">Rich Editor UI Components docs</a> or using our CLI tool.</p>
<pre><code>npm install @rich-editor/starter-kit</code></pre>
<h2>Features</h2>
