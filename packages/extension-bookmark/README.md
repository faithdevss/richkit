# @richkitjs/extension-bookmark

Bookmark block extension — links rendered as preview cards for [@richkitjs/core](https://www.npmjs.com/package/@richkitjs/core), a headless ProseMirror-based rich text editor.

## Install

```sh
npm install @richkitjs/extension-bookmark @richkitjs/core
```
